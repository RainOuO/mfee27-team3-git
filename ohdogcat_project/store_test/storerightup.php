                ...
                <a class="btn btn-info" href="user.php">取消</a>
                            ...
                            <form class="form2 px-3" action="storeRightupALL.php" method="POST">
                                ...
                                <div>
                                    ...
                                    <img class="trip" src="./IMAGES/travel-luggage.png" alt="" style="width: 100px; height:auto;">
                                </div>
                                <br>
                                <div>
                                <input class="tripinput" type="checkbox" name="type_2" value="2">餐廳
                                    <img class="trip" src="./IMAGES/cafe.png" alt="" style="width: 100px; height:auto;">
                                    </div>
                                <br>
                                <div>
                                <input class="tripinput" type="checkbox" name="type_3" value="3">旅館
                                    <img class="trip" src="./IMAGES/hotel.png" alt="" style="width: 100px; height:auto;">
                                    </div>
                                <br>
                                <div>
                                <input class="tripinput" type="checkbox" name="type_4" value="4">寵物商品
                                    <img class="trip" src="./IMAGES/pet-house.png" alt="" style="width: 100px; height:auto;">
                                    </div>
                                <br>
