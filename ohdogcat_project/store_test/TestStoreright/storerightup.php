            ...
            <div class="container-fluid h-100 py-4 overflow-hidden">
                ...
                <a class="btn btn-info" href="user.php">取消</a>
                            ...
                            <form class="form2 px-3" action="storeRightupALL.php" method="POST">
                                <table>
                                    <label class="title" for="">興趣:</label>
                                    <br>
                                    <input type="checkbox" name="name" value="1">音樂
                                    <br>
                                    <input type="checkbox" name="name" value="2">爬山
                                    <br>
                                    <input type="checkbox" name="name" value="3">運動
                                    <br>
                                    <input type="checkbox" name="name" value="4">閱讀
                                    <br>
