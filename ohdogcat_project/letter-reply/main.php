            ...
            <div class="row g-0">
                <div class="col-md-1 d-flex justify-content-center align-items-center object-cover">
                    <?php if($row['reply_status'] == 1): ?>
                        <div class="w-100 h-100 p-3"><div class="ratio ratio-1x1"><img class="stickers object-fit" src="../images/profile-user.png" class="img-fluid rounded-start" alt="..."></div></div>
                    <?php else: ?>
