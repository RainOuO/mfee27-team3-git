    ...
    <div class="photobar d-flex flex-column col-5">
        <div class="photo-window d-flex flex-column align-items-flex-start ">
            <div class="cover-photo">
                ...
                <?php else : ?>
                <img src="../images/upload_main_photo/<?= $row['main_photo'] ?>" alt="">
                <?php endif; ?>
            </div>
            <div class="swiper mySwiper mt-2">
                <div class="swiper-wrapper">
                    ...
                    <?php else : ?>
                    <div class="swiper-slide photo1"><img class="" src="../images/upload_sub_photo/<?= $rowS ?>" alt="">
                    </div>
                    <?php endif; ?>
                    <?php endforeach; ?>
                </div>
...
<form action="">
    ...
    <textarea class="form-control" style="resize:none" rows="10" placeholder="請輸入文案" maxlength="500"
