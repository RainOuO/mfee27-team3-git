...
if ($_FILES["main_photo"]["error"] == 0 || $_FILES["sub_photo"]["error"] == 0) {
    if (
        ...
        //TO-DO
        $sqlPhoto = "UPDATE  product  SET main_photo ='$fileNameC', sub_photo = CONCAT('$fileNameS,')  WHERE id = $id";
        echo $sqlPhoto;
...
$sqlUpdate="UPDATE product SET name = '$name', intro = '$intro', description = '$description', price = '$price',
 ...
 stock_quantity = '$stock', coupon_id = '$coupon', main_photo = '$main_photo', sub_photo = '$sub_photo,' WHERE id = '$id'";
