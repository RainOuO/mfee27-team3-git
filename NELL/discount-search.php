...
if (!isset($_GET["search"])) {
    ...
    //模糊比對
    $sql = "SELECT id, name, category_id, description,amount, discount_number,discount_code,start_time,end_time, buyer_valid FROM discount WHERE name LIKE '%$search%'";
...
<body>
    <div class="container">
        <div class="py-2">
            <a href="discounts.php" class="btn btn-info">回優惠券列表</a>
